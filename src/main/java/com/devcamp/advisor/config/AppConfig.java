 ...
 *
 * Required env vars:
 *   GOOGLE_API_KEY - your Google API key for Gemini (from Google AI Studio)
 *
 * NOTE: This application uses native Gemini Grounding with Google Search.
 * No separate Search Engine ID or Custom Search API key is required.
 */
